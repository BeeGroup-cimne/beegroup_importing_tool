...
def harmonize_building_emm(data, **kwargs):
    data = [{'Unique ID': 'eP-EAZK-371', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-372', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-373', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-374', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-375', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-376', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-377', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-378', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-379', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-380', 'Název projektu / opatření': nan, 'Realizovaná opatření': nan, 'Datum': nan,
             'Životnost opatření': nan, 'Investice (Kč)': nan, 'Dotace (Kč)': nan, 'Směnný kurz (Kč/EUR)': 25.0,
             'Roční energetické úspory (GJ)': nan, 'Roční úspora CO2 (tuny)': nan, 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-001', 'Název projektu / opatření': 'Zateplení kina Hluk',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - podlaha;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře;_x000D_\nHVAC a teplá voda - topný systém',
             'Datum': '2016-2017', 'Životnost opatření': 30.0, 'Investice (Kč)': 21166298.6, 'Dotace (Kč)': 1494919.15,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 170.2, 'Roční úspora CO2 (tuny)': 19.79,
             'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-002', 'Název projektu / opatření': 'Energetické úspory Karolinka Kobylská 391',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře;_x000D_\nHVAC a teplá voda - topný systém',
             'Datum': '2016-2017', 'Životnost opatření': 30.0, 'Investice (Kč)': 2251983.04, 'Dotace (Kč)': 565322.11,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 91.64, 'Roční úspora CO2 (tuny)': 5.09,
             'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-003', 'Název projektu / opatření': 'Energetické úspory Karolinka Nábřežní 175',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - podlaha;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře',
             'Datum': '2016-2017', 'Životnost opatření': 30.0, 'Investice (Kč)': 3180059.51, 'Dotace (Kč)': 1087513.98,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 219.15, 'Roční úspora CO2 (tuny)': 12.18,
             'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-004', 'Název projektu / opatření': 'Zateplení objektu č.p. 428 Bánov',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře',
             'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 2147785.3, 'Dotace (Kč)': 789039.06,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 183.95, 'Roční úspora CO2 (tuny)': 10.17,
             'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-005', 'Název projektu / opatření': 'Revitalizace šaten Pozlovice',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře;_x000D_\nKonstrukce budovy - střecha a stropy',
             'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 2668588.0, 'Dotace (Kč)': 760887.19,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 57.0, 'Roční úspora CO2 (tuny)': 5.5,
             'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-006', 'Název projektu / opatření': 'Energetické úspory Karolinka Vsetínská 73',
             'Realizovaná opatření': 'Konstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - zdi;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře',
             'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 1820127.62, 'Dotace (Kč)': 538450.4,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 75.97, 'Roční úspora CO2 (tuny)': 4.22,
             'Komentáře': nan}, {'Unique ID': 'eP-EAZK-007',
                                 'Název projektu / opatření': 'Zateplení budovy hasičské zbrojnice v Bohuslavicích u Zlína',
                                 'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - dveře',
                                 'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 1098602.0,
                                 'Dotace (Kč)': 423413.99, 'Směnný kurz (Kč/EUR)': 25.0,
                                 'Roční energetické úspory (GJ)': 33.17, 'Roční úspora CO2 (tuny)': 1.84,
                                 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-008', 'Název projektu / opatření': 'Energetické úspory KD v Petrůvce',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nHVAC a teplá voda - topný systém a teplá voda',
             'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 1589728.0, 'Dotace (Kč)': 631315.04,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 104.56, 'Roční úspora CO2 (tuny)': 9.18,
             'Komentáře': nan}, {'Unique ID': 'eP-EAZK-009',
                                 'Název projektu / opatření': 'Energetické úspory: objekt TJ sokol Horní Bečva',
                                 'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - podlaha;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře;_x000D_\nHVAC a teplá voda - topný systém',
                                 'Datum': 2017, 'Životnost opatření': 30.0, 'Investice (Kč)': 4391307.37,
                                 'Dotace (Kč)': 1720055.4, 'Směnný kurz (Kč/EUR)': 25.0,
                                 'Roční energetické úspory (GJ)': 168.74, 'Roční úspora CO2 (tuny)': 50.47,
                                 'Komentáře': nan},
            {'Unique ID': 'eP-EAZK-010', 'Název projektu / opatření': 'Dům služeb Liptál č.p. 81 - energetické úspory',
             'Realizovaná opatření': 'Konstrukce budovy - zdi;_x000D_\nKonstrukce budovy - střecha a stropy;_x000D_\nKonstrukce budovy - okna;_x000D_\nKonstrukce budovy - dveře',
             'Datum': '2017-2018', 'Životnost opatření': 30.0, 'Investice (Kč)': 1373018.53, 'Dotace (Kč)': 411459.35,
             'Směnný kurz (Kč/EUR)': 25.0, 'Roční energetické úspory (GJ)': 89.02, 'Roční úspora CO2 (tuny)': 4.95,
             'Komentáře': nan}]

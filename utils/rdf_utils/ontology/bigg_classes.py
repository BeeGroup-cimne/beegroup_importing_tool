...
class Baseline(BIGGObjects):
    ...
    def __init__(self, subject, baselineDefinition=None,baselinePerimeter=None,baselineNonAdjustedValue=None,baselineAdjustedValue=None,baselineUnit=None,hasBaselineInfluenceFactor=None):
        super().__init__(subject)
...
class Building(BIGGObjects):
    ...
    def __init__(self, subject, buildingIDFromOrganization=None,buildingName=None,buildingConstructionYear=None,buildingOpeningHour=None,buildingClosingHour=None,hasBuildingConstructionType=None,hasBuildingOwnership=None,pertainsToOrganization=None,hasCadastralInfo=None,hasLocationInfo=None,hasProject=None,hasSpace=None,hasResult=None,hasEPC=None):
        super().__init__(subject)
...
class BuildingElement(BIGGObjects):
    ...
    def __init__(self, subject, buildingElementIDFromOrganization=None,buildingElementState=None,buildingElementPurchaseDate=None,buildingElementInstallationDate=None,buildingElementBrand=None,buildingElementModel=None,buildingElementSerialNumber=None,buildingElementManufacturer=None,buildingElementManufactureDate=None):
        super().__init__(subject)
...
class BuildingSpace(BIGGObjects):
    ...
    def __init__(self, subject, builidingSpaceIDFromOrganization=None,buildingSpaceName=None,hasBuildingSpaceUseType=None,hasResult=None,hasIndoorQualityPerception=None,hasArea=None,containsElement=None,isAssociatedWithElement=None,isObservedByDevice=None,hasDeviceAggregator=None,containsZone=None,hasSubSpace=None,hasOccupancyProfile=None):
        super().__init__(subject)
...
class BuildingSystemElement(BIGGObjects):
    ...
    def __init__(self, subject, buildingSystemElementMinOutput=None,buildingSystemElementMaxOutput=None,buildingSystemElementEfficiency=None,hasBuildingSystemElementType=None):
        super().__init__(subject)
...
class CadastralInfo(BIGGObjects):
    ...
    def __init__(self, subject, landCadastralReference=None,landGeometry=None,landArea=None,landGraphicalArea=None,propertyClass=None,hasLandType=None):
        super().__init__(subject)
...
class EnergyPerformanceContract(BIGGObjects):
    ...
    def __init__(self, subject, contractID=None,contractName=None,contractPerimeter=None,contractStartDate=None,contractEndDate=None,hasObjective=None):
        super().__init__(subject)
...
class ContractObjective(BIGGObjects):
    ...
    def __init__(self, subject, objectiveID=None,objectiveName=None,objectiveDescription=None,objectiveTargetValue=None,objectiveDeadline=None,hasObjectiveTargetType=None,hasObjectiveTargetValueUnit=None,isConnectedToEnergySaving=None):
        super().__init__(subject)
...
class CO2EmissionsFactor(BIGGObjects):
    ...
    def __init__(self, subject, gridCO2EmissionsFactor=None,gridCO2EmissionsFactorStart=None,gridCO2EmissionsFactorEnd=None):
        super().__init__(subject)
...
class Device(BIGGObjects):
    ...
    def __init__(self, subject, deviceIDFromOrganization=None,deviceName=None,deviceManufacturer=None,deviceModel=None,deviceNumberOfOutputs=None,deviceOperatingSystem=None,deviceLicenceVersionNumber=None,hasDeviceType=None,hasDeviceInputSignalType=None,hasDeviceInputProtocol=None,observesSpace=None,observesElement=None,hasUtilityPointOfDelivery=None,hasSensor=None,hasDeviceHistory=None,hasState=None,isInWeatherStation=None,isPartOfDeviceAggregator=None):
        super().__init__(subject)
...
class DeviceHistory(BIGGObjects):
    ...
    def __init__(self, subject, deviceSerialNumber=None,deviceManufactureDate=None,deviceInstallationDate=None,deviceRemovalDate=None,deviceThresholdValue=None):
        super().__init__(subject)
...
class Element(BIGGObjects):
    ...
    def __init__(self, subject, isContainedInSpace=None,isAssociatedWithSpace=None,isObservedByDevice=None,isAffectedByMeasure=None,isSubjectToMaintenance=None,isContainedInSystem=None,hasSubElement=None):
        super().__init__(subject)
...
class EnergyEfficiencyMeasure(BIGGObjects):
    ...
    def __init__(self, subject, energyEfficiencyMeasureID=None,energyEfficiencyMeasureLifetime=None,energyEfficiencyMeasureDescription=None,shareOfAffectedElement=None,energyEfficiencyMeasureOperationalDate=None,energyEfficiencyMeasureInvestment=None,energyEfficiencyMeasureCurrencyExchangeRate=None,energyEfficiencyMeasureSavingsToInvestmentRatio=None,energySourcePriceEscalationRate=None,energyEfficiencyMeasureFinancialSavings=None,energyEfficiencyMeasureCO2Reduction=None,hasEnergyEfficiencyMeasureType=None,hasEnergyEfficiencyMeasureInvestmentCurrency=None,affectsElement=None,producesSaving=None,producesNonEnergyBenefit=None):
        super().__init__(subject)
...
class EnergyPerformanceCertificate(BIGGObjects):
    ...
    def __init__(self, subject, energyPerformanceCertificateReferenceNumber=None,energyPerformanceCertificateDateOfAssessment=None,energyPerformanceCertificateDateOfCertification=None,energyPerformanceCertificationTool=None,energyPerformanceProcedureType=None,energyPerformanceCertificationMotivation=None,energyPerformanceClass=None,annualPrimaryEnergyConsumption=None,CO2EmissionsClass=None,annualCO2Emissions=None,annualFinalEnergyConsumption=None,annualEnergyCost=None,heatingCO2EmissionsClass=None,annualHeatingCO2Emissions=None,coolingCO2EmissionsClass=None,annualCoolingCO2Emissions=None,hotWaterCO2EmissionsClass=None,annualHotWaterCO2Emissions=None,lightingCO2EmissionsClass=None,annualLightingCO2Emissions=None,heatingPrimaryEnergyClass=None,annualHeatingPrimaryEnergyConsumption=None,coolingPrimaryEnergyClass=None,annualCoolingPrimaryEnergyConsumption=None,hotWaterPrimaryEnergyClass=None,annualHotWaterPrimaryEnergyConsumption=None,lightingPrimaryEnergyClass=None,annualLightingPrimaryEnergyConsumption=None,heatingEnergyDemandClass=None,annualHeatingEnergyDemand=None,coolingEnergyDemandClass=None,annualCoolingEnergyDemand=None,hasAdditionalInfo=None):
        super().__init__(subject)
...
class EnergyPerformanceCertificateAdditionalInfo(BIGGObjects):
    ...
    def __init__(self, subject, electricVehicleChargerPresence=None,solarThermalSystemPresence=None,solarPVSystemPresence=None,biomassSystemPresence=None,geothermalSystemPresence=None,districtHeatinOrCoolingConnection=None,buildingTecnicalInspectionCode=None,averageFacadeTransmittance=None,averageWindowsTransmittance=None,regulationValueForFacadeTransmittance=None,regulationValueForWindowsTransmittance=None,constructionRegulation=None):
        super().__init__(subject)
...
class EnergySaving(BIGGObjects):
    ...
    def __init__(self, subject, energySavingValue=None,energySavingStartDate=None,energySavingEndDate=None,energySavingIndependentlyVerified=None,hasEnergySavingType=None,hasEnergySavingVerificationSource=None,influencesObjective=None):
        super().__init__(subject)
...
class IndoorQualityPerception(BIGGObjects):
    ...
    def __init__(self, subject, indoorQualityEvaluationValidityStartDate=None,indoorQualityEvaluationValidityEndDate=None,hasIndoorQualityUserPerception=None):
        super().__init__(subject)
...
class LocationInfo(BIGGObjects):
    ...
    def __init__(self, subject, addressPostalCode=None,addressStreetName=None,addressStreetNumber=None,addressLatitude=None,addressLongitude=None,addressAltitude=None,hasAddressCountry=None,hasAddressProvince=None,hasAddressCity=None,hasAddressClimateZone=None):
        super().__init__(subject)
...
class MaintenanceAction(BIGGObjects):
    ...
    def __init__(self, subject, maintenanceActionID=None,maintenanceActionDate=None,maintenanceActionName=None,maintenanceActionDescription=None,maintenanceActionIsPeriodic=None,maintenanceActionFrequency=None,hasMaintenanceActionType=None,maintainsElement=None):
        super().__init__(subject)
...
class DeviceAggregator(BIGGObjects):
    ...
    def __init__(self, subject, deviceAggregatorFormula=None,deviceAggregatorName=None,deviceAggregatorFrequency=None,deviceAggregatorTimeAggregationFunction=None,hasDeviceAggregatorProperty=None,hasResult=None,isInSpace=None,includesDevice=None):
        super().__init__(subject)
...
class NonEnergyBenefit(BIGGObjects):
    ...
    def __init__(self, subject, nonEnergyBenefitImpactValueVerifiedAndMeasured=None,nonEnergyBenefitImpactVerificationMethod=None,nonEnergyBenefitImpactValue=None,nonEnergyBenefitImpactValueDescription=None,hasNonEnergyBenefitType=None,hasNonEnergyBenefitImpactEvaluation=None,hasNonEnergyBenefitImpactValueUnit=None):
        super().__init__(subject)
...
class OccupancyProfile(BIGGObjects):
    ...
    def __init__(self, subject, occupancyProfileValidityStartDate=None,occupancyProfileValidityEndDate=None,occupancyNumberOfOccupants=None,occupancyVacationDates=None):
        super().__init__(subject)
...
class Organization(BIGGObjects):
    ...
    def __init__(self, subject, organizationID=None,organizationName=None,organizationLocalVAT=None,organizationDivisionType=None,organizationContactPersonName=None,organizationEmail=None,organizationTelephoneNumber=None,hasOrganizationType=None,hasSubOrganization=None,isManagedByPerson=None,buysContract=None,providesContract=None,managesBuilding=None):
        super().__init__(subject)
...
class Project(BIGGObjects):
    ...
    def __init__(self, subject, projectID=None,projectTitle=None,projectDescription=None,geometrySRID=None,affectsBuilding=None,hasRetrofitProject=None,hasRenovationProject=None):
        super().__init__(subject)
...
class RetrofitProject(BIGGObjects):
    ...
    def __init__(self, subject, projectStartDate=None,projectOperationalDate=None,projectInvestment=None,projectCurrencyExchangeRate=None,projectUsesIncentives=None,projectInventivesShareOfRevenues=None,projectReceivedGrantFunding=None,projectGrantsShareOfCosts=None,projectDiscountRate=None,projectInterestRate=None,projectInternalRateOfReturn=None,projectSimplePaybackTime=None,projectNetPresentValue=None,projectSavingsToInvestmentRatio=None,projectIncludedNonEnergyBenefitsEstimate=None,projectIncludedConfortmeterSurvey=None,projectCO2Reduction=None,hasProjectMotivation=None,hasProjectInvestmentCurrency=None,includesMeasure=None,producesSaving=None,producesNonEnergyBenefit=None):
        super().__init__(subject)
...
class RenovationProject(BIGGObjects):
    ...
    def __init__(self, subject, projectStartDate=None,projectOperationalDate=None,projectInvestment=None,projectCurrencyExchangeRate=None,projectUsesIncentives=None,projectInventivesShareOfRevenues=None,projectReceivedGrantFunding=None,projectGrantsShareOfCosts=None,projectDiscountRate=None,projectInterestRate=None,projectInternalRateOfReturn=None,projectSimplePaybackTime=None,projectNetPresentValue=None,projectSavingsToInvestmentRatio=None,projectIncludedNonEnergyBenefitsEstimate=None,projectIncludedConfortmeterSurvey=None,hasProjectMotivation=None,hasProjectInvestmentCurrency=None,producesSaving=None,producesNonEnergyBenefit=None):
        super().__init__(subject)
        self.projectStartDate = projectStartDate
        self.projectOperationalDate = projectOperationalDate
        self.projectInvestment = projectInvestment
